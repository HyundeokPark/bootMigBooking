			...
			<div class="ct_wrap">
				...
				<form action ="comment" method = "post" id = "form" enctype="multipart/form-data">
					...
					<div class="write_act">
						...
						<div class="review_rating rating_point">
							<div class="rating">
								...
								<input type="hidden" name="rating" value="0" class="rating_rdo" title="0점">
							</div>
						</div>
					</div>
					<!-- //리뷰 별점 -->
					...
					<div class="review_contents write">
						...
						<textarea name = "reviewContent" cols="30" rows="10" class="review_textarea"    ></textarea> <!-- maxlength = "400" required minlength = "5" -->
					</div>
					<!-- //리뷰 입력 -->
					...
					<div class="review_write_footer_wrap">
						<div class="review_write_footer">
							...
							<input type="file" class="hidden_input" id="reviewImageFileOpenInput" name = "file">
							<div class="guide_review">
								<span>0</span>/400
								<span>(최소5자이상)</span>
							</div>
						</div>
						<div class="comment_msg" style="display:none">최소5자 ~ 최대 400자 입력하셔야 합니다.</div>
						<!-- 리뷰 포토 -->
