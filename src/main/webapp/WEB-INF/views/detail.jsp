    ...
    <div id="container">
        <div class="header fade">
            <header class="header_tit">
                ...
                <a  href="bookinglogin" class="btn_my"> <span class="viewReservation" title="예약확인">예약 확인</span> </a>
            </header>
        </div>
        <div class="ct main">
            <div>
                                ...
                                <ul class="visual_img detail_swipe">
                                        ...
                                        <div class="visual_txt">
                                            <div class="visual_txt_inn">
                                                ...
                                                <p class="visual_txt_dsc"> ${displayInfo[0].getProductDescription()} </p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                ...
                <div class="section_store_details">
                    ...
                    <div class="store_details close3" id="storeDetailes">
                        <p class="dsc">
                        ${displayInfo[0].getProductContent()}
                        </p>
                    </div>
                    <!-- [D] 토글 상황에 따라 bk_more에 display:none 추가 -->
                    <a  class="bk_more _open" id="bk_more"> <span class="bk_more_txt">펼쳐보기</span> <i class="fn fn-down2"></i> </a>
                    <a  class="bk_more _close" id="bk_more_close"style="display: none;"> <span class="bk_more_txt">접기</span> <i class="fn fn-up2"></i> </a>
                </div>
                ...
                <div class="section_btn"> <button type="button" class="bk_btn"> <i class="fn fn-nbooking-calender2"></i> <a href = "reserve?displayInfoId=${displayInfo[0].getDisplayInfoId()}"><span>예매하기</span> </a></button> </div>
                        ...
                        <div class="short_review_area">
                            <div class="grade_area">
                                ...
                                <c:if test = "${ not empty avgScore}" >
                                	<span class="graph_mask"> <em class="graph_value" style="width: ${avgScore/5.0*100}% "></em> </span>
		                                ...
		                                <li class="list_item">
		                                    <div>
		                                        <div class="review_area">
		                                            <c:if test = "${ not empty comment.getCommentImg().getFileId()}" >
		                                            <div class="thumb_area">
		                                                <a href="#" class="thumb" title="이미지 크게 보기"> <img width="90" height="90" class="img_vertical_top" src="http://localhost:8080/booking/displayimgbyId?name=${comment.getCommentImg().getFileId()}" alt=""> </a> <span class="img_count" style="display:none;">1</span>                                                </div>
		                                            </c:if>
		                                            <h4 class="resoc_name"></h4>
		                                            <p class="review">${comment.getComment()}</p>
		                                        </div>
		                                        <div class="info_area">
		                                            <div class="review_info"> <span class="grade">${comment.getScore()}</span> <span class="name">${comment.getReservationEmail()}</span> <span class="date">${comment.getReservationDate()} 방문</span> </div>
		                                        </div>
		                                    </div>
		                                </li>
	                                 </c:forEach>
...
<!--                                 </li> -->
                    ...
                    <a class="btn_review_more" href="review?displayInfoId=${displayInfo[0].getDisplayInfoId()}"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
                </div>
                        ...
                        <div class="box_store_info no_topline">
                            ...
                            <div class="store_info">
                                <div class="store_addr_wrap">
                                    ...
                                    <p class="store_addr store_addr_bold">${displayInfo[0].getPlaceLot()}</p>
                                    <p class="store_addr">
                                        <span class="addr_old">지번</span>
                                        <span class="addr_old_detail">${displayInfo[0].getPlaceStreet()}</span>
                                    </p>
                                    <p class="store_addr addr_detail">${displayInfo[0].getPlaceName()}</p>
                                </div>
                                <div class="lst_store_info_wrap">
                                    <ul class="lst_store_info">
                                        <li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i> <span class="sr_only">전화번호</span> </span> <span class="item_rt"> <a href="tel:02-548-0597" class="store_tel">${displayInfo[0].getTelephone()}</a></span> </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <script src="./js/common.js"></script>
     <input type="hidden" name="displayInfoId" id="displayInfoId" value="${displayInfo[0].getDisplayInfoId()}">
</body>

 <script type="rv-template" id="tmplBtmTab">
			{{#if productContent}}
			<div class="detail_area_wrap">
                        <div class="detail_area">
                        <div class="detail_info">
 					...
 					<div class="detail_location">
                        <div class="box_store_info no_topline">
                            ...
                            <div class="store_info">
                                ...
                                <div class="lst_store_info_wrap">
                                    <ul class="lst_store_info">
                                        <li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i> <span class="sr_only">전화번호</span> </span> <span class="item_rt"> <a href="tel:02-548-0597" class="store_tel">{{telephone}}</a></span> </li>
                                    </ul>
                                </div>
                            </div>
							<!-- [D] 모바일 브라우저에서 접근 시 column2 추가와 btn_navigation 요소 추가 -->
 ...
 <script type="rv-template" id="tmplLocation">
	                    <div class="detail_location">
                        <div class="box_store_info no_topline">
                            <a href="#" class="store_location" title="지도웹으로 연결">
                                <img class="store_map img_thumb" alt="map" src="https://simg.pstatic.net/static.map/image?version=1.1&amp;crs=EPSG:4326&amp;baselayer=bl_vc_bg&amp;exception=xml&amp;scale=2&amp;caller=mw_smart_booking&amp;overlayers=ol_vc_an&amp;center=127.0011948,37.5717079&amp;markers=type,default2,127.0011948,37.5717079&amp;level=11&amp;w=340&amp;h=150">
