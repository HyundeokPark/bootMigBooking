	    ...
	    <div id="container">
	        ...
	        <div class="event" id = "evntDiv">
	                            ...
	                            <div class="container_visual">
	                                ...
	                                <ul class="visual_img">
		                            	...
		                            	<li id="listPromo${count}" >
		            							<p>${count}</p>
		                            		<img src = "${promotion.getProductImageUrl()}" alt ="프로모션 이미지 입니다." >
		                                </li>
            	...
            	<div class="section_event_lst">
                	<p class="event_lst_txt">바로 예매 가능한 행사가 <span class="pink">${mainList.size()}개</span> 있습니다</p>
		                        ...
		                        <c:if test= "${mainCount % 2 eq 0}">
			                        ...
			                        <li class="item" id = "main${mainCount}" >
			                            <a href="detail.html" class="item_book">
			                                <div class="item_preview"> <img alt="${mainItem.getTitle()}" class="img_thumb" src="${mainItem.getPath()}">
