				...
				<div class="my_summary">
					<ul class="summary_board">
						<li class="item">
							...
							<a href="" class="link_summary_board on"> <i class="spr_book2 ico_book2"></i> <em class="tit">전체</em> <span id="totalCount" class="figure">${reservaionList.size()} </span> </a>
						</li>
						<li class="item">
							<a href="" class="link_summary_board"> <i class="spr_book2 ico_book_ss"></i> <em class="tit">이용예정</em> <span id="rsvCount" class="figure">${reservations.size()}</span> </a>
						</li>
						<li class="item">
							<a href="" class="link_summary_board"> <i class="spr_book2 ico_check"></i> <em class="tit">이용완료</em> <span id="usdCount" class="figure">${usdRsvs.size()}</span> </a>
						</li>
						<li class="item">
							<a href="" class="link_summary_board"> <i class="spr_book2 ico_back"></i> <em class="tit">취소·환불</em> <span id="canceledCount" class="figure">${canceledRsvs.size()}</span> </a>
						</li>
					</ul>
				</div>
				<!--// 예약 현황 -->
										...
										<div class="card_body">
											...
											<div class="middle">
												<div class="card_detail">
													...
													<h4 class="tit">${rsv.getDisplayInfo().getProductDescription()}</h4>
													<ul class="detail">
														<li class="item">
															<span class="item_tit">일정</span>
															<em class="item_dsc">
																${rsv.getReservation_date()}
															</em>
														</li>
														<li class="item">
															<span class="item_tit">내역</span>
															<em class="item_dsc">
																${rsv.getDisplayInfo().getProductContent()}
															</em>
														</li>
														<li class="item">
															<span class="item_tit">장소</span>
															<em class="item_dsc">
																${rsv.getDisplayInfo().getPlaceStreet()}
															</em>
														</li>
														<li class="item">
...
<!-- 														[D] 예약 신청중, 예약 확정 만 취소가능, 취소 버튼 클릭 시 취소 팝업 활성화 -->
													<div class="booking_cancel">
														...
														<input type = "hidden" name = "reservationInfoId" value = "${rsv.getId()}">
														<input type = "hidden" name = "productId" value = "${rsv.getProduct_id()}">
													</div>
												</div>
											</div>
											<div class="right"></div>
						...
						<li class="card used">
							...
							<c:forEach items = "${usdRsvs}" var ="rsv">
								<article class="card_item">
									<a class="link_booking_details">
										<div class="card_body">
											<div class="left"></div>
...
<!-- 														[D] 예약 신청중, 예약 확정 만 취소가능, 취소 버튼 클릭 시 취소 팝업 활성화 -->
						...
						<li class="card used cancel">
							...
							<c:forEach items = "${canceledRsvs}" var ="rsv">
									<article class="card_item">
										<a class="link_booking_details">
											<div class="card_body">
												<div class="left"></div>
